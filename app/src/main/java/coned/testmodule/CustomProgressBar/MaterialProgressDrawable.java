...
package coned.testmodule.CustomProgressBar;
...
/**
 * Fancy progress_background indicator for Material theme.
 *
 * @hide
 */
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * The duration of a single progress_background spin in milliseconds.
     */
    private static final int ANIMATION_DURATION = 1000 * 80 / 60;
    /**
     * The number of points in the progress_background "star".
     */
    ...
    /**
     * Set the overall size for the progress_background spinner. This updates the radius
    ...
    /**
     * @param show Set to true to display the arrowhead on the progress_background spinner.
     */
    ...
    /**
     * Set the start and end trim for the progress_background spinner arc.
     *
    ...
    /**
     * Set the amount of rotation to apply to the progress_background spinner.
     *
    ...
    /**
     * Set the colors used in the progress_background animation from color resources.
    ...
    private static class Ring {
        ...
        // progress_background circle should currently display. As the progress_background circle is
        ...
        /**
         * Draw the progress_background spinner
         */
        ...
        /**
         * Set the colors the progress_background spinner alternates between.
         *
         ...
         *              the progress_background spinner.
         */
        ...
        /**
         * @return Current alpha of the progress_background spinner and arrowhead.
         */
        public int getAlpha() {
            return mAlpha;
        }
        ...
        /**
         * @param alpha Set the alpha of the progress_background spinner and associated arrowhead.
         */
        public void setAlpha(int alpha) {
            mAlpha = alpha;
        }
        ...
        /**
         * @param strokeWidth Set the stroke width of the progress_background spinner in pixels.
         */
        ...
        /**
         * @param centerRadius Inner radius in px of the circle the progress_background
         *                     spinner arc traces.
         */
        ...
        /**
         * @param show Set to true to show the arrow head on the progress_background spinner.
         */
        ...
        /**
         * @return The amount the progress_background spinner is currently rotated, between [0..1].
         */
        ...
        /**
         * Reset the progress_background spinner to default rotation, start and end angles.
         */
